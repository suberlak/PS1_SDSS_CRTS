...
Similarly to \cite{charisi2016, suberlak2017}, we perform  light curve cleaning. Of 8516 light curves with 662 092 epochs, we remove 14 156  $5\sigma$ outliers in photometric uncertainty and magnitude space. We also perform day averaging (error weighted) when more than 1 epoch was available per night, which further reduces the śnumber of epochs by 67 615. If combined nightly error was $<0.02#, we add in quadrature $0.01$ mag.  In the final sample there are 580 321 epochs.  % same as Sec. 2.3 Suberlak2017....
