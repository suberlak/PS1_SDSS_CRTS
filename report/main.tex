...
than with SDSS data alone.The variability amplitude dependence on the quasar luminosity is weaker. We make predictions for the fidelity of DRW model parameter retrieval with ZTF and LSST data. 
\end{abstract}
