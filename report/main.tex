...
\caption{Same as Fig.~\ref{fig:drw_tau_posterior},  but fitting quasar absolute magnitude $M_{i}$, and black hole mass $M_{BH}$ in Eq.~\ref{eq:powlawmodel} as a function of the asymptotic amplitude ($f = SF_{\infty}$). New data from PS1 is consistent with earlier results of M10 on luminosity dependence, but supports slightly weaker dependence of $SF_{\infty}$ on $M_{BH}$ (by 0.06 dex).}
