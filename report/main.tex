...
\caption{Simulated DRW process ($\tau=575$d, $SF_{\infty} = 0.2$ mag, 1 day cadence) subsampled at the real cadence of SDSS, PS1 segments, and simulated LSST epochs, using time stamps from the combined SDSS-PS1 light curve for quasar dbID=1072282. The 'error snake' is an envelope marking the standard deviation of the fit to the data using a Gaussian process  with DRW kernel (Sec.~\ref{sec:simulation}).}
\label{fig:simLC}
\end{figure} 
