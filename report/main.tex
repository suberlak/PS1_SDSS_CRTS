...
Fig.~\ref{fig:combinedLCerrors} shows, due to shallower depth these surveys have larger photometric uncertainties (median $\sim 0.1$ mag) for objects as faint as quasars (median 20 mag) - see Fig.~\ref{fig:combinedLCerrors}
